...
MiyaValidator.ERROR_MESSAGE = {
    /* for element */
    required   : "¹Ýµå½Ã ÀÔ·ÂÇÏ¼Å¾ß ÇÏ´Â Ç×¸ñÀÔ´Ï´Ù.",
    requiredstring : "¹Ýµå½Ã {required}(À¸)·Î ÀÔ·ÂÇÏ¼Å¾ß ÇÏ´Â Ç×¸ñÀÔ´Ï´Ù.",
    ...
    minlength  : "ÀÔ·ÂµÈ ³»¿ëÀÇ ±æÀÌ°¡ {minlength}ÀÚ ÀÌ»óÀÌ¾î¾ß ÇÕ´Ï´Ù.",
    maxlength  : "ÀÔ·ÂµÈ ³»¿ëÀÇ ±æÀÌ°¡ {maxlength}ÀÚ¸¦ ÃÊ°úÇÒ ¼ö ¾ø½À´Ï´Ù.",
	...
	engdigit   : "¿µ¹® ¶Ç´Â ¼ýÀÚ·Î¸¸ ÀÔ·ÂÇÏ¼Å¾ß ÇÕ´Ï´Ù.",
	...
	normalengname : "ÀÏ¹ÝÀûÀÎ ¿µ¹® ÀÌ¸§ Çü½ÄÀÌ ¾Æ´Õ´Ï´Ù."
};
/**
 * form control types
 */
...
/*
     FILE ARCHIVED ON 17:17:58 Mar 15, 2015 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 41.374 (3)
  esindex: 0.008
  captures_list: 59.0
  CDXLines.iter: 10.192 (3)
  PetaboxLoader3.datanode: 104.277 (5)
  exclusion.robots: 0.406
  exclusion.robots.policy: 0.376
  RedisCDXSource: 3.998
  PetaboxLoader3.resolve: 85.294 (2)
  load_resource: 227.913
*/